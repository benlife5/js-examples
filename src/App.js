...
fetch("https://opentdb.com/api.php?amount=10").then((res) => res.json().then((json) => console.log("one-line-results", json.results)))
...
/*
Uses:
1) Just do something... no need to worry about when it resolves
  Write to database
2) Read and update state... setState called at the end of the chain
*/
